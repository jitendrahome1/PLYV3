...
//    public var onSelect:(String, NSIndexPath)->() = {_,_ in}
    open var onSelect:(String, [String:AnyObject],IndexPath)->() = {_,_ ,_ in}
    ...
    open var autoCompleteUtilityObjects:[[String:AnyObject]]?
    ...
    fileprivate func setupAutocompleteTable(_ view:UIView){
        ...
        view.superview!.addSubview(tableView)
...
extension AutoCompleteTextField: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let selectedText = cell?.textLabel?.text {
            ...
            onSelect(selectedText, autoCompleteUtilityObjects![indexPath.row], indexPath)
        }
