//
//  PYLRechargeMobileViewController.swift
//  Peyala
//
...
class PYLRechargeMobileViewController: PYLBaseTableViewController, CNContactPickerDelegate {
    ...
    @IBOutlet weak var txtFieldOperator: UITextField!
    ...
    func setUpperNavigationItems() {
        self.title = "Recharge/Top up Mobile"
    ...
    func setupUI() {
        ...
        btnPrepaid.imageView?.contentMode = UIViewContentMode.scaleAspectFit
        btnPostpaid.imageView?.contentMode = UIViewContentMode.scaleAspectFit
        
        prepaidEnableSettings()
    }
    ...
    func validateFields() -> Bool {
        ...
        else if txtFieldOperator.text!.isBlank  {
            validate = false
            self.view.showToastWithMessage("Current Operator"+LEFT_BLANK)
        }
    ...
    func prepaidEnableSettings() {
        //radio buttons
        btnPrepaid.isSelected = true
        btnPrepaid.isUserInteractionEnabled = false
        
        btnPostpaid.isSelected = false
        btnPostpaid.isUserInteractionEnabled = true
    }
    
    func postpaidEnableSettings() {
        //radio buttons
        btnPostpaid.isSelected = true
        btnPostpaid.isUserInteractionEnabled = false
        
        btnPrepaid.isSelected = false
        btnPrepaid.isUserInteractionEnabled = true
    }
    ...
    @IBAction func prepaidPostpaidBtnAction(_ sender: UIButton) {
        if (sender == btnPrepaid) {
            prepaidEnableSettings()
        }
        else {
            postpaidEnableSettings()
        }
    }
...
extension PYLRechargeMobileViewController: UITextFieldDelegate {
